...
const Accordion = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-gray-900 pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
...
>
      ...
      <div
        className={`pl-[62px] duration-200 ease-in-out dark:text-white ${
          active ? "block" : "hidden"
        }`}
      >
