        ...
        {currentStep === 2 && (
          <>
            ...
            <p className="mb-2 pt-7 text-m font-bold text-center py-4 text-dark dark:text-white sm:text-l md:text-[20px]">
                Answer the following question to successfully Register for Start Up Expo
              </p>
            <div className="mb-6">
              <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              Imagine you are the CEO of a tech company. With the rise of artificial 
              intelligence, how would you strategically position your company for the 
              next decade, considering both opportunities and threats?
              </label>
              <textarea
                  id="question1"
                  // name="question1"
            ...
            <div className="mb-6">
              <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              If your company received negative publicity due to a product issue, how 
              would you rebuild customer trust and maintain a customer-centric focus, 
            ...
            <div className="mb-6">
              <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              If your company's brand image is at risk due to negative online reviews 
              and social media backlash, describe the steps you would take to address 
              the situation and rebuild a positive brand reputation
              </label>
              <textarea
                  id="question3"
                  name="question3"
            ...
            <div className="mb-6">
              <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              During an economic downturn, how would you lead your company to not 
              only survive but also thrive, balancing cost-cutting measures with 
            ...
            <div className="mb-6">
              <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
              You're leading a company planning to expand into a new international 
              market. Describe the key considerations, challenges, and strategies you 
              would employ to ensure a successful market entry.
              </label>
              <textarea
                  id="question5"
                  name="question5"
