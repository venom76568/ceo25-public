...
const Hero = () => {
  return (
    <>
      <div className="w-full h-screen bg-auto sm:bg-contain md:bg-cover lg:bg-cover xl:bg-cover bg-[url(https://static.vecteezy.com/system/resources/thumbnails/003/042/243/small/abstract-blue-grunge-texture-background-free-vector.jpg)]">
        <h1 className="text-center text-6xl font-bold pt-5 text-[#00a4f9] pt-5">
