        ...
        <div className="w-64 h-82 p-2 bg-whilte rounded-lg transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl relative">
          ...
          <div className="p-2 mb-3 hover:static">
            ...
            <div className="flex mt-3  gap-2 ml-2 justify-evenly	">
              ...
              {/* Linkedin */}
              <div>
                <FaLinkedin size="1.8rem" className="hover:w-14 hover:duration-150"/>
              </div>
              
              {/* email */}
              <div >
                <MdEmail size="1.8rem" className="hover:w-14 hover:duration-150 "/>
              </div>

              {/* phone number */}
              <div >
                <FaPhone size="1.8rem" className="hover:w-14 hover:duration-150"/>
              </div>
            </div>
          </div>
        </div>
